// Here we displays all the orders users have placed till now
// Once we have the user authenticated and user's orders
// display all them in a card-based view using map func
