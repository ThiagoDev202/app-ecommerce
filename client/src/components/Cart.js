// Here i display the user's cart.
// showing all the items a user has in cart
// show an option to remove them from the cart
// and the final, gives the option to checkout (pay for the products and order them)
